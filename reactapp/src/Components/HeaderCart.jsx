...
//     <Link
//       to="/cart"
//       className="relative w-11 h-11 rounded-full bg-gray-100 hover:bg-orange-100 flex items-center justify-center"
//     >
//       <ShoppingCart size={20} />

//       {cartCount > 0 && (
//         <span className="absolute -top-1 -right-1 w-5 h-5 bg-orange-500 text-white text-[10px] flex items-center justify-center rounded-full animate-bounce">
//           {cartCount}
//         </span>
//       )}
//     </Link>
